    ...
    private class DownloadTask extends AsyncTask<String, Integer, Result> {
        ...
        protected Result doInBackground(String... urls) {
            ...
            if (!isCancelled() && urls != null && urls.length > 0) {
                // Gets the html from me website
                String urlString = "https://people.cs.vt.edu/~alyssa2/";
                // TODO: this is how ur supposed to get the url but it isn't working :(
                //// urls[0];
                try {
            ...
            Log.d("UrlContent", "result " + result.resultValue);
            return result;
        }
